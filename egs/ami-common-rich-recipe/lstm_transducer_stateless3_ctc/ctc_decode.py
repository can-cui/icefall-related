...
./lstm_transducer_stateless3_ctc/ctc_decode.py \
    --epoch 40 \
    --avg 15 \
    --exp-dir ./lstm_transducer_stateless3_ctc/exp \
    --max-duration 600 \
...
def decode_one_batch(
    ...
    encoder_out, encoder_out_lens, _ = model.encoder(feature, feature_lens)
