...
class Transducer(nn.Module):
    ...
    def forward(
        ...
        def get_loss(encoder_out, x_lens, y,decoder):
        ...
        simple_loss_common, pruned_loss_common=get_loss(encoder_out, x_lens, y_common,self.decoder_common)
        simple_loss_rich, pruned_loss_rich=get_loss(encoder_out, x_lens, y_rich,self.decoder_rich)
