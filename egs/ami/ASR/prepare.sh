...
#   CONDA_CHANGEPS1=true conda activate gss
# fi
...
#
# dl_dir=$PWD/download
dl_dir=/srv/storage/talc2@talc-data2.nancy.grid5000.fr/multispeech/calcul/users/ccui/datasets/AMI
annotations_dir="/srv/storage/talc2@talc-data2.nancy.grid5000.fr/multispeech/calcul/users/ccui/datasets/AMI/annotations/"
...
if [ $stage -le 1 ] && [ $stop_stage -ge 1 ]; then
  ...
  for mic in ihm; do
    lhotse prepare ami --annotations $annotations_dir --mic $mic --partition full-corpus-asr --normalize-text kaldi \
...
if [ $stage -le 4 ] && [ $stop_stage -ge 4 ]; then
  ...
  lhotse combine data/manifests/cuts_train_{ihm,ihm_rvb,sdm,gss}.jsonl.gz - | shuf |
    # lhotse combine data/manifests/cuts_train_{gss}.jsonl.gz - | shuf |
