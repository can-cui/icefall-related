...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=$id python3 ./pruned_transducer_stateless7/train.py \
    --world-size 4 \
    --num-epochs 15 \
    --start-epoch 1 \
    --exp-dir pruned_transducer_stateless7/exp_all \
    --max-duration 150 \
    --use-fp16 True

python3 ./pruned_transducer_stateless7/decode.py \
    --epoch 15 \
    --avg 1 \
    --exp-dir ./pruned_transducer_stateless7/exp_all \
    --max-duration 100 \
...
# python3 ./pruned_transducer_stateless7/decode.py --exp-dir pruned_transducer_stateless7/exp --epoch 15 --avg 2 --decoding-method greedy_search --bpe-model data/lang_bpe_500/bpe_common.model
...
# python ./pruned_transducer_stateless7_book_e2e/decode_ami.py --mode-id 1 --exp-dir $exp_dir --epoch 56 --avg 5 --decoding-method greedy_search --bpe-model data/lang_bpe_500/bpe_book.model
