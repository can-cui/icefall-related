...
def preprocess():
    ...
    for partition in dataset_parts:
        ...
        lookup = {}
        # rich_transcript = f"data/bert-rich-uncase/{partition}-rich.txt" # uncase
        rich_transcript = f"data/books-transcription-uncase/{partition}-rich-book-filtered.txt" # book
        ...
        # new_cuts_path = output_dir / f"librispeech_cuts_{partition}_rich_uncase.jsonl.gz" # uncase
        new_cuts_path = output_dir / f"librispeech_cuts_{partition}_book_uncase.jsonl.gz" # book
