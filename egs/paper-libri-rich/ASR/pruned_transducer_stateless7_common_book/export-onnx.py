...
def main():
    ...
    encoder = OnnxEncoder(
        ...
        encoder_proj=model.joiner_common.encoder_proj,
    )

    decoder = OnnxDecoder(
        decoder=model.decoder_common,
        decoder_proj=model.joiner_common.decoder_proj,
    )

    joiner = OnnxJoiner(output_linear=model.joiner_common.output_linear)
