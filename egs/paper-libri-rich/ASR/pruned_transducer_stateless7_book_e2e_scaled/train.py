...
def compute_loss(
    ...
    with torch.set_grad_enabled(is_training):
        ...
        if params.scaled_loss:
            common_rich_scale = torch.tensor([params.scaled_value_rich*2 if item == 1 else (1-params.scaled_value_rich)*2 for item in id_list]).to(device)
