...
class Transducer(nn.Module):
    ...
    def __init__(
        ...
        decoder_uncase: nn.Module,
        joiner_common: nn.Module,
        joiner_rich: nn.Module,
        joiner_uncase: nn.Module,
        encoder_dim: int,
        decoder_dim: int,
        joiner_dim: int,
        vocab_size: int,
    ...
    def forward(
        ...
        assert y_uncase.num_axes == 2, y_uncase.num_axes
        ...
        simple_loss_uncase, pruned_loss_uncase=get_loss(encoder_out, x_lens, y_uncase,self.decoder_uncase,self.joiner_uncase)
        return (simple_loss_common, pruned_loss_common,simple_loss_rich, pruned_loss_rich,simple_loss_uncase, pruned_loss_uncase)
