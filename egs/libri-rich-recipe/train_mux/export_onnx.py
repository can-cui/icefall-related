...
from lstm_exp import RNN
from decoder import Decoder
from scaling_converter import convert_scaled_to_non_scaled
from train_mux import add_model_arguments, get_params, get_transducer_model
...
class OnnxEncoder(nn.Module):
    ...
    def __init__(self, encoder: RNN, encoder_proj: nn.Linear,ctc_model):
        """
        Args:
          encoder:
            LSTM encoder.
