...
class OnnxEncoder(nn.Module):
    ...
    def forward(
        ...
        """
        x_lens=torch.zeros(x.size(0), dtype=torch.int64)+x.size(1)
        ...
        return encoder_proj_out, new_h, new_c
...
def main():
    ...
    encoder_filename = params.exp_dir / f"encoder-{suffix}-stream.onnx"
    ...
    decoder_filename = params.exp_dir / f"decoder-{suffix}-stream.onnx"
    ...
    joiner_filename = params.exp_dir / f"joiner-{suffix}-stream.onnx"
